      ...
      <div className="information-page">
        <div className="information-page__inner-container">
          ...
          <article className="information">
            ...
            <h2>Collection of you information</h2>
            <p>
            ...
            <p>
              ...
              to the Site, such as online chat and message boards. You are under
            ...
            <p>
              ...
              processor, [Amazon Payments,] [Apple Pay,] [Google Checkout,]
              [Paypal,] [Stripe,] [other], and you are encouraged to review
              their privacy policy and contact them directly for responses to
              your questions.]
            </p>
            ...
            <h2>By Law or to protect right</h2>
            <p>
            ...
            <p>
              If you connect to the Site through a social network, your contacts
            ...
            <p>
              We may use cookies, web beacons, tracking pixels, and other
              tracking technologies on the Site to help customize the Siteand
              improve your experience. For more information on how we use
              cookies, please refer to our&nbsp;
              <Link to="/cookie-policy">Cookie Policy</Link> posted on the Site,
            ...
            <p>
              ...
              [Adobe Analytics,] [Clicktale,] [Clicky,] [Cloudfare,] [Crazy
              Egg,] [Flurry Analytics,] [Google Analytics,] [Heap Analytics,]
              [Inspectlet,] [Kissmetrics,] [Mixpanel,] [Piwik,] and others], to
              allow tracking technologies and remarketing services on the Site
              through the use of first party cookies and third-party cookies,
              ...
              However, if you do not want any information to be collected and
              used by tracking technologies, you can visit the third-party
